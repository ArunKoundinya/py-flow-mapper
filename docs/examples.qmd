...
graph LR
    ...
    ext_sklearn_compose_ColumnTransformer --> ext_sklearn_preprocessing_OneHotEncoder
    ...
    main_build_pipeline --> |model,preprocessor| ext_sklearn_pipeline_Pipeline
...
graph LR
    ...
    mermaid_generator_generate_detailed_flow_graph --> |c,call_name,callee,current_module,fileish_callee,mod,p,producer,src_call,tgt_call| mermaid_generator_external_root_name
    ...
    mermaid_generator_generate_detailed_flow_graph --> |c,callee,current_module,mod,p,src_call,tgt_call| mermaid_generator_keep_external
    ...
    analyzer_visit_Call --> |node,t,transformer_node| analyzer__extract_call_info
    ...
    analyzer__extract_call_info -.->|ci| analyzer_visit_Call
    analyzer__extract_call_info -.->|ci| analyzer_visit_Call
